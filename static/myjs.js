function post() {
    ...
    let imageFile = $("#input-pic")[0].files[0];
  
    // Buat objek FormData dan masukkan data yang diperlukan
    let formData = new FormData();
    formData.append("comment_give", comment);
    formData.append("date_give", today);
    formData.append("image_give", imageFile); // Tambahkan file gambar ke FormData
  
    // Kirim permintaan AJAX dengan FormData
    $.ajax({
      type: "POST",
      url: "/posting",
      data: formData,
      contentType: false, // Atur contentType ke false agar jQuery tidak mengaturnya secara otomatis
      processData: false, // Atur processData ke false agar jQuery tidak memproses FormData
              ...
              post["username"]
                                                  ...
                                                  <nav class="level is-mobile">
                                                      <div class="level-left">
                                                          ...
                                                          <a class="level-item is-star" aria-label="star" onclick="toggle_star('${
                                                            post["_id"]
                                                          }', 'star')">
                                                          ...
                                                          <a class="level-item is-thumbsup" aria-label="thumbsup" onclick="toggle_thumbsup('${
                                                            post["_id"]
                                                          }', 'thumbsup')">
